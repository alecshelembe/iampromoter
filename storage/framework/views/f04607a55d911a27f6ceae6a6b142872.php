...
<head>
    ...
    <link rel="icon" href="<?php echo e(config('services.project.logo_image')); ?>" type="image/x-icon">
    <link href="https://cdn.jsdelivr.net/npm/flowbite@2.5.1/dist/flowbite.min.css" rel="stylesheet">
    
    <!-- ---------------------- -->
     <!-- More sources -->
    <!-- <script defer src="https://cdn.ckeditor.com/4.16.0/standard/ckeditor.js"></script> -->
    <!-- <script src="<?php echo e(asset('js/offline-ckeditor.js')); ?>"></script> -->
    ...
    <!-- <script defer src="<?php echo e(asset('js/ckeditor.js')); ?>"></script> -->
    ...
    <style>
        ...
        .Scibono-background {
             ...
             background-image: url('<?php echo e(asset('storage/sci-bono-content/browser-fill-2.png')); ?>');
...
<?php /**PATH /var/www/package/resources/views/welcome.blade.php ENDPATH**/ ?>