...
<div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-10">
    <h2 class="text-2xl font-bold text-center text-gray-800">
        <?php echo e($socialPost->place_name ?? 'N/A'); ?>

    </h2>
    <p class="text-center text-gray-600 mt-2">
        <?php echo e($socialPost->address ?? 'No address provided'); ?>
    ...
    <div class="mt-6 border rounded-lg p-4 bg-gray-100">
        ...
        <div class="  mt-2 text-gray-600">
            <p>Contact </p>
            <p><?php echo e($socialPost->email ?? 'N/A'); ?></p>
        </div>
        <div class="  mt-2 text-gray-600">
            <p>Total</p>
            <p>R <?php echo e($socialPost->fee ?? 'N/A'); ?></p>
        </div>
    </div>
    
    <form id="initialForm" action="<?php echo e(route('payment.process')); ?>" method="POST">
    <?php echo csrf_field(); ?>
            <?php
            ...
            <div class="hidden">
                    ...
                    <?php $__currentLoopData = $transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <input type="text" name="<?php echo e($key); ?>" id="<?php echo e($key); ?>" value="<?php echo e($value); ?>" />
                        <br />
...
document.addEventListener("DOMContentLoaded", function() {
    $(document).ready(function() {
        $('#initialForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?php echo e(route("payment.transaction.process")); ?>', // Your route for handling the form submission
                type: 'POST',
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/package/resources/views/payfast/book-now.blade.php ENDPATH**/ ?>