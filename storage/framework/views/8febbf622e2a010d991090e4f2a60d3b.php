        ...
        <?php else: ?>
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <img 
                        ...
                        src="<?php echo e($user->profile_image_url ? Storage::url($user->profile_image_url) : asset('images/default-avatar.png')); ?>" 
                        alt="<?php echo e($user->first_name); ?>'s image"
                    />
                    ...
                    <span class="text-sm text-gray-500 dark:text-gray-400">
                        <?php echo e($user->position ?? 'User'); ?>

                    </span>

                    <p class="text-gray-600 text-center dark:text-gray-400 mt-2 text-sm">
                        <?php echo e($user->google_location ?? 'No location available'); ?>

                    </p>

                    <div class="flex flex-wrap justify-center mt-4 space-x-2">
                        <?php $__currentLoopData = ['instagram', 'linkedin', 'tiktok', 'youtube', 'x', 'other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                                $handle = $user->{$platform . '_handle'};
                            ?>
                            <?php if(!empty($handle)): ?>
                                <a href="<?php echo e(Str::startsWith($handle, 'http') ? $handle : 'https://' . $handle); ?>" 
                                   ...
                                   class="py-2 px-3 text-sm font-medium bg-white hover:bg-blue-100 hover:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                    <i class="fa-brands fa-<?php echo e($platform === 'x' ? 'x-twitter' : $platform); ?>"></i> 
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/package/resources/views/public-profile.blade.php ENDPATH**/ ?>