...
<script defer src="<?php echo e(asset('js/get-user-location.js')); ?>"></script>
...
<div class="flex justify-end mb-4">
  <form id="upload-form" action="<?php echo e(route('social.save.post')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <!-- Name -->
    <div class="my-4">
      <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Post Name</label>
      <input type="text" name="place_name" value="<?php echo e(old('place_name')); ?>" id="place_name" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" placeholder="Name of your venture" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="relative z-0 w-full mb-5 text-center my-2 group">
      ...
      <input type="text" name="floating_address" value="<?php echo e(old('floating_address')); ?>" id="floating_address" class="text-center block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
          ...
          <?php $__errorArgs = ['floating_sectors_value'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/package/resources/views/mobile/create.blade.php ENDPATH**/ ?>