...
<div class="max-w-4xl mx-auto p-6 bg-gray-50 rounded-lg shadow-lg mt-10">
    ...
    <p class="text-gray-600 mb-6">
        At Promotions, we value your satisfaction and aim to provide a seamless experience. However, we understand that issues may arise. This policy outlines our approach to refunds, including applicable fees and investigation timelines.
    </p>
